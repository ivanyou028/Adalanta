...
def main(client, customer_id):
    campaign_budget_service_request = client.get_type("MutateCampaignBudgetsRequest")
    ...
    campaign_budget_service_request.operations = [campaign_budget_operation]
    campaign_budget_service_request.customer_id = customer_id

    # Add budget.
    try:
        campaign_budget_response = campaign_budget_service.mutate_campaign_budgets(request=campaign_budget_service_request)
